...
function Login_user() {
    ...
    const upload_img = () => {
        ...
        axios.put(`https://cloud-server-2-again.vercel.app/payment/${upload_id}`, formdata)
            .then((res) => {
    ...
    const Export_certificate = async (reg_id) => {
        ...
        await axios.get('https://cloud-server-2-again.vercel.app/get_single_certi/' + reg_id).then((res) => {
    ...
    const get_single_reg = async () => {
        ...
        // await doc.addImage(`https://cloud-server-2-again.vercel.app/images/${single_certi.profile_img}`, 'JPEG', 41, 232, 25, 30)
        // await doc.addImage(`https://cloud-server-2-again.vercel.app/${single_certi.profile_img}`, 'PNG', 41, 232, 25, 30)

        const img = new Image()
        img.src = await `https://cloud-server-2-again.vercel.app/images/${single_certi.profile_img}`
        img.onload = () => {
    ...
    const submit_login = () => {
        ...
        axios.post("https://cloud-server-2-again.vercel.app/login_user", {
            reg_id: reg_id,
            id_card: id_card
        }).then((res) => {
